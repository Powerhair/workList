export const questions = [
...

  {
    ...
    question: "Введите расстояние от технического зрения до шкафа управления",
    type: "input",
  },
  {
    name: "tagSensor",
  ...
  },
  {
    ...
    question:
      "Введите расстояние от шкафа управления до светозвукоовой колонны. Если светозвуковая колонна устанавливается на шкаф укажите 0",
    type: "input",
  },
];
